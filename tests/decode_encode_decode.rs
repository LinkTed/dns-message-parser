...
fn txt_example_org_response() {
    ...
    \x03\x6f\x72\x67\x00\x00\x10\x00\x01\xc0\x0c\x00\x10\x00\x01\x00\x00\x0e\x10\x00\x18\x05\x54\
    \x65\x78\x74\x31\x05\x54\x65\x78\x74\x32\x05\x54\x65\x78\x74\x33\x05\x54\x65\x78\x74\x34";
    decode_encode_decode(&msg[..]);
}
...
#[test]
fn opt_expire_example_org_request_1() {
    let msg = b"\x46\x53\x01\x20\x00\x01\x00\x00\x00\x00\x00\x01\x07\x65\x78\x61\x6d\x70\x6c\x65\
    \x03\x6f\x72\x67\x00\x00\x01\x00\x01\x00\x00\x29\x10\x00\x00\x00\x80\x00\x00\x04\x00\x09\x00\
    \x00";
    decode_encode_decode(&msg[..]);
}

#[test]
fn opt_expire_example_org_request_2() {
    let msg = b"\x46\x53\x01\x20\x00\x01\x00\x00\x00\x00\x00\x01\x07\x65\x78\x61\x6d\x70\x6c\x65\
    \x03\x6f\x72\x67\x00\x00\x01\x00\x01\x00\x00\x29\x10\x00\x00\x00\x80\x00\x00\x08\x00\x09\x00\
    \x04\x00\x00\x00\x01";
    decode_encode_decode(&msg[..]);
}
...
#[test]
fn nsec_example_org_request() {
    let msg = b"\xc0\xc9\x01\x20\x00\x01\x00\x00\x00\x00\x00\x00\x07\x65\x78\x61\x6d\x70\x6c\x65\
    \x03\x6f\x72\x67\x00\x00\x2f\x00\x01";
    decode_encode_decode(&msg[..]);
}

#[test]
fn nsec_example_org_response() {
    let msg = b"\xc0\xc9\x85\x00\x00\x01\x00\x01\x00\x00\x00\x00\x07\x65\x78\x61\x6d\x70\x6c\x65\
    \x03\x6f\x72\x67\x00\x00\x2f\x00\x01\xc0\x0c\x00\x2f\x00\x01\x00\x00\x0e\x10\x00\x1a\x04\x6e\
    \x65\x78\x74\x07\x65\x78\x61\x6d\x70\x6c\x65\x03\x6f\x72\x67\x00\x00\x06\x40\x01\x00\x00\x00\
    \x03";
    decode_encode_decode(&msg[..]);
}
...
#[test]
fn caa_example_org_request() {
    let msg = b"\x75\xfc\x01\x20\x00\x01\x00\x00\x00\x00\x00\x00\x03\x63\x61\x61\x07\x65\x78\x61\
    \x6d\x70\x6c\x65\x03\x6f\x72\x67\x00\x01\x01\x00\x01";
    decode_encode_decode(&msg[..]);
}

#[test]
fn caa_example_org_response() {
    ...
    \x00\x0a\x80\x03\x74\x61\x67\x56\x41\x4c\x55\x45";
    decode_encode_decode(&msg[..]);
}
