...
fn a_example_org_response() {
    ...
    \x00\x0a\x00";
    decode_msg_error(&msg[..], DecodeError::TooMuchData);
}
...
fn mg_example_org_request_error() {
    ...
    \x61\x69\x6c\xc0\x0c";
    decode_msg_error(&msg[..], DecodeError::NotEnoughData);
}
...
fn afsdb_example_org_response_2() {
    ...
    decode_msg_error(&msg[..], DecodeError::AFSDBSubtypeError(3));
}
...
fn sshfp_example_org_response_1() {
    ...
    decode_msg_error(&msg[..], DecodeError::SSHFPAlgorithmError(3));
}
...
fn sshfp_example_org_response_2() {
    ...
    \x12\x34\x56\x78\x9a\xbc\xde\xf6\x78\x90\x12\x34\x56\x78\x9a\xbc\xde\xf6\x78\x90";
    decode_msg_error(&msg[..], DecodeError::SSHFPTypeError(2));
}
